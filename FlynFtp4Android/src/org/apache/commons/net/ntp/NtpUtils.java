...
public final class NtpUtils
{
     ...
     * invalid (non-ASCII character) then returns empty string "". For details
     * refer to the <A
     * HREF="http://www.eecis.udel.edu/~mills/ntp/html/refclock.html#list"
     * >Comprehensive List of Clock Drivers</A>.
     * 
     * @param message
