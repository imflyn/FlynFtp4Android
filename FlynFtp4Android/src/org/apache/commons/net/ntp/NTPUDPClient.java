 ...
 * </a> to retrieve the time. Then call <a
 * href="org.apache.commons.net.DatagramSocketClient.html#close"> close </a> to
 * close the connection properly. Successive calls to <a href="#getTime">
...
public final class NTPUDPClient extends DatagramSocketClient
{
     ...
     * returns it. The time is the number of miliiseconds since 00:00 (midnight)
     * 1 January 1900 UTC, as specified by RFC 1305. This method reads the raw
     * NTP packet and constructs a <i>TimeInfo</i> object that allows access to
     * all the fields of the NTP message header.
     * <p>
     * 
     * @param host
    ...
    public TimeInfo getTime(InetAddress host, int port) throws IOException
    {
        ...
        /*
         * Must minimize the time between getting the current time, timestamping
         * the packet, and sending it out which introduces an error in the delay
         * time. No extraneous logging and initializations here !!!
         */
        TimeStamp now = TimeStamp.getCurrentTime();

        // Note that if you do not set the transmit time field then originating
        // time
        // in server response is all 0's which is
        // "Thu Feb 07 01:28:16 EST 2036".
     ...
     * NTP port and returns it. The time is the number of miliiseconds since
     * 00:00 (midnight) 1 January 1900 UTC, as specified by RFC 1305. This
     * method reads the raw NTP packet and constructs a <i>TimeInfo</i> object
     * that allows access to all the fields of the NTP message header.
     * <p>
     * 
     * @param host
     *            The address of the server.
     ...
     * packet that is sent to remote host (e.g. 3=NTP v3, 4=NTP v4, etc.)
     * 
