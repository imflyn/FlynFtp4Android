 ...
 * 
 * @version $Id: DotTerminatedMessageReader.java 1301276 2012-03-15 23:51:31Z
 *          sebb $
 */
public final class DotTerminatedMessageReader extends BufferedReader
{
            ...
            if (atBeginning)
            {
                ...
                { // Have DOT
                    ...
                    { // Have DOT CR
                        chint = super.read();
                        if (chint == -1)
                        { // Still only DOT CR - should not happen
                          // new
                          // Throwable("Trailing DOT CR").printStackTrace();
                    ...
                    // new
                    // Throwable("Lone DOT followed by "+(char)chint).printStackTrace();
                    reset();
                    return DOT;
                } // have DOT
            } // atBeginning
     ...
     * return followed immediately by a linefeed. This contrasts with
     * BufferedReader which also allows other combinations.
     * 
     * @since 3.0
     */
    @Override
