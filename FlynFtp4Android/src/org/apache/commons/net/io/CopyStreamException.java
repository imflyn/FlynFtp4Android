 ...
 * copyStream() methods. It stores the number of bytes confirmed to have been
 * transferred before an I/O error as well as the IOException responsible for
 * the failure of a copy operation.
 * 
 * @see Util
...
public class CopyStreamException extends IOException
{
     ...
     *            The total number of bytes transferred before an exception was
     *            thrown in a copy operation.
     * @param exception
