...
/**
 * A CopyStreamEvent is triggered after every write performed by a stream
 * copying operation. The event stores the number of bytes transferred by the
 * write triggering the event as well as the total number of bytes transferred
...
public class CopyStreamEvent extends EventObject
{
     ...
     *            The total number of bytes transferred so far during a copy
     *            operation.
     * @param bytesTransferred
     *            The number of bytes transferred during the write that
     *            triggered the CopyStreamEvent.
     * @param streamSize
     *            The number of bytes in the stream being copied. This may be
     *            set to <code>UNKNOWN_STREAM_SIZE</code> if the size is
     *            unknown.
     */
    ...
    /**
     * Returns the number of bytes transferred by the write that triggered the
     * event.
     * 
     * @return The number of bytes transferred by the write that triggered the
     *         vent.
     */
    ...
    /**
     * Returns the size of the stream being copied. This may be set to
     * <code>UNKNOWN_STREAM_SIZE</code> if the size is unknown.
     * 
