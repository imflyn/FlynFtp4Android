...
/***
 * This class wraps an output stream, replacing all occurrences of
 ...
 * <p>
 * Because of the translation process, a call to <code>flush()</code> will not
 * flush the last byte written if that byte was a carriage return. A call to
...
public final class FromNetASCIIOutputStream extends FilterOutputStream
{
    ...
    /***
     * Writes a byte to the stream. Note that a call to this method might not
     * actually write a byte to the underlying stream until a subsequent
     * character is written, from which it can be determined if a NETASCII line
     * separator was encountered. This is transparent to the programmer and is
