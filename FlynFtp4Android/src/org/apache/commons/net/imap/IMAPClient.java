...
/**
 * The IMAPClient class provides the basic functionalities found in an IMAP
 * client.
 */
public class IMAPClient extends IMAP
{
    ...
    /**
     * Send a NOOP command to the server. This is useful for keeping a
     * connection alive since most IMAP servers will timeout after 10 minutes of
     * inactivity.
     * 
     * @return {@code true} if the command was successful,{@code false} if not.
     * @exception IOException
     ...
     * you must call disconnect(). A logout attempt is valid in any state. If
     * the client is in the not authenticated or authenticated state, it enters
     * the logout on a successful logout.
     * 
     * @return {@code true} if the command was successful,{@code false} if not.
     * @exception IOException
     *                If a network I/O error occurs.
    ...
    /**
     * Login to the IMAP server with the given username and password. You must
     ...
     * the NOT_AUTH_STATE. After logging in, the client enters the AUTH_STATE.
     * <p>
     * 
     * @param username
     ...
     *            The existing mailbox name to rename.
     ...
     *            The mailbox name.
     * @param flags
     *            The flag parenthesized list (optional).
     * @param datetime
     ...
     * 
     * @param sequenceSet
     *            The sequence set to store.
     * @param itemNames
     *            The item names for the STORE command.
     * @param itemValues
    ...
    public enum SEARCH_CRITERIA
    {
        ...
        FROM,
        /**
         * Messages that have a header with the specified field-name (as defined
         * in [RFC-2822]) and that contains the specified string in the text of
         * the header (what comes after the colon). If the string to search is
         * zero-length, this matches all messages that have a header line with
        ...
        LARGER,
        /**
         * Messages that have the \Recent flag set but not the \Seen flag. This
    ...
    public enum FETCH_ITEM_NAMES
    {
        ...
        FULL,
        /**
         * Non-extensible form of BODYSTRUCTURE or the text of a particular body
         * section.
         */
        BODY,
