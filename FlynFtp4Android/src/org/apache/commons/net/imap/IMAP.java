...
public class IMAP extends SocketClient
{
    ...
    /**
     * The default IMAPClient constructor. Initializes the state to
     ...
     * 
     * @param wantTag
     *            {@code true} if the command expects a tagged response.
     * @throws IOException
     */
    ...
    /**
     * Sets IMAP client state. This must be one of the <code>_STATE</code>
     * constants.
     * <p>
     * 
     * @param state
     ...
     * 
     * @param command
     *            The IMAP command to send (one of the IMAPCommand constants).
     * @param args
     *            The command arguments.
     * @return The server reply code (see IMAPReply).
     */
    ...
    /**
     * Sends a command and arguments to the server and return whether
     * successful.
     * <p>
     * 
     * @param command
     ...
     * the server. The lines have end of lines truncated.
     * 
     ...
     * single string containing all the reply lines including newlines.
     * <p>
     * 
     * @return The last server response.
     */
