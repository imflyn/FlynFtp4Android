...
public class AuthenticatingIMAPClient extends IMAPSClient
{
    ...
    /**
     * Authenticate to the IMAP server by sending the AUTHENTICATE command with
     * the selected mechanism, using the given username and the given password.
     * <p>
     * 
     ...
     *                password.
     */
    public boolean authenticate(AuthenticatingIMAPClient.AUTH_METHOD method, String username, String password) throws IOException, NoSuchAlgorithmException, InvalidKeyException,
    ...
    public boolean auth(AuthenticatingIMAPClient.AUTH_METHOD method, String username, String password) throws IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException
    {
        ...
        switch (method)
        {
            case PLAIN:
            {
                ...
                // to read it.
                int result = sendData(Base64.encodeBase64StringUnChunked(("\000" + username + "\000" + password).getBytes(getCharsetName()))); // Java
                                                                                                                                               // 1.6
                                                                                                                                               // can
                                                                                                                                               // use
                                                                                                                                               // getCharset()
            ...
            case LOGIN:
            {
                ...
                if (sendData(Base64.encodeBase64StringUnChunked(username.getBytes(getCharsetName()))) != IMAPReply.CONT) // Java
                                                                                                                         // 1.6
                                                                                                                         // can
                                                                                                                         // use
                                                                                                                         // getCharset()
                ...
                int result = sendData(Base64.encodeBase64StringUnChunked(password.getBytes(getCharsetName()))); // Java
                                                                                                                // 1.6
                                                                                                                // can
                                                                                                                // use
                                                                                                                // getCharset()
