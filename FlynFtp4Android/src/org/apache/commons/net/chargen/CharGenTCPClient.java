 ...
 * these protocols involve connecting to the appropriate port, and reading data
 * from an input stream. The chargen protocol actually sends data until the
 * receiving end closes the connection. All of the others send only a fixed
 * amount of data and then close the connection.
 * <p>
 * To use the CharGenTCPClient class, just establish a connection with
 * {@link org.apache.commons.net.SocketClient#connect connect } and call
 * {@link #getInputStream getInputStream() } to access the data. Don't close the
 * input stream when you're done with it. Rather, call
 * {@link org.apache.commons.net.SocketClient#disconnect disconnect } to clean
 * up properly.
 * <p>
 * <p>
 * 
...
public final class CharGenTCPClient extends SocketClient
{
    ...
    /***
     * The default constructor for CharGenTCPClient. It merely sets the default
     ...
     * You should NOT close the InputStream when you're finished reading from
