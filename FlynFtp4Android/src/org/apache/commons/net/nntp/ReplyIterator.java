...
/**
 * Wraps a {@link BufferedReader} and returns an {@code Iterable<String>} which
 * returns the individual lines from the reader.
 * 
 * @since 3.0
 */
class ReplyIterator implements Iterator<String>, Iterable<String>
{
     ...
     *            the reader to wrap
     * @param addDotReader
     *            whether to additionally wrap the reader in a
    ...
    public String next() throws NoSuchElementException
    {
        ...
        {
            savedException = ex; // if it fails, save the exception, as it does
