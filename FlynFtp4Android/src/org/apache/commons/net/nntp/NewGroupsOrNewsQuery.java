 ...
 * {@link org.apache.commons.net.nntp.NNTPClient#listNewNewsgroups
 * listNewNewsGroups } and
 * {@link org.apache.commons.net.nntp.NNTPClient#listNewNews listNewNews }
 * respectively. It prevents you from having to format date, time, distribution,
 * and newgroup arguments.
 * <p>
...
public final class NewGroupsOrNewsQuery
{
     ...
     * 
     * @param date
     *            The date since which new groups or news have arrived.
     * @param gmt
    ...
    /***
     * Add a newsgroup to the list of newsgroups being queried. Newsgroups added
     * this way are only meaningful to the NEWNEWS command. Newsgroup names may
     * include the <code> * </code> wildcard, as in <code>comp.lang.* </code> or
     * <code> comp.lang.java.* </code>. Adding at least one newsgroup is
     * mandatory for the NEWNEWS command.
     * <p>
     * 
     * @param newsgroup
     *            The newsgroup to add to the list of groups to be checked for
     *            new news.
     ***/
     ...
     * that group should not be checked for new news. Newsgroups added this way
     * are only meaningful to the NEWNEWS command. Newsgroup names may include
     * the <code> * </code> wildcard, as in <code>comp.lang.* </code> or
     * <code> comp.lang.java.* </code>.
     * <p>
     * The following would create a query that searched for new news in all
     * comp.lang.java newsgroups except for comp.lang.java.advocacy.
     * 
     * <pre>
     ...
     * @param newsgroup
     *            The newsgroup to add to the list of groups to be checked for
     *            new news, but which should be omitted from the search for new
     *            news..
     ***/
     ...
     * newsgroup is the segment of the name preceding the first dot (e.g., comp,
     * alt, rec). Only those newsgroups matching one of the distributions or, in
     * the case of NEWNEWS, an article in a newsgroup matching one of the
     * distributions, will be reported as a query result. Adding distributions
     * is purely optional.
     * <p>
     * 
     * @param distribution
    ...
    /***
     * Return the comma separated list of distributions. This may be null if
    ...
    /***
     * Return the comma separated list of newsgroups. This may be null if there
     * are no newsgroups
     * <p>
     * 
