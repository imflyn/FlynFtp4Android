...
public abstract class TelnetOptionHandler
{
    ...
    /***
     * Returns a boolean indicating whether to send a WILL request to the other
     * end upon connection.
     * <p>
     * 
    ...
    /***
     * Returns a boolean indicating whether to send a DO request to the other
     * end upon connection.
     * <p>
     * 
    ...
    /***
     * Method called upon reception of a subnegotiation for this option coming
     * from the other end. Must be implemented by the actual TelnetOptionHandler
     * to specify which response must be sent for the subnegotiation request.
     * <p>
     * 
     * @param suboptionData
    ...
    /***
     * This method is invoked whenever this option is acknowledged active on the
     * local end (TelnetClient sent a WILL, remote side sent a DO). The method
     * is used to specify a subnegotiation sequence that will be sent by
     * TelnetClient when the option is activated.
     * <p>
     * 
    ...
    /***
     * This method is invoked whenever this option is acknowledged active on the
     * remote end (TelnetClient sent a DO, remote side sent a WILL). The method
     * is used to specify a subnegotiation sequence that will be sent by
     * TelnetClient when the option is activated.
     * <p>
     * 
