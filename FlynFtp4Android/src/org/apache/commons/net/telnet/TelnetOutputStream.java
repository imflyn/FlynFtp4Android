 ...
 * <p>
 * In ASCII mode, if convertCRtoCRLF is true, any CR is converted to CRLF. IACs
 * are doubled.
 * <p>
 ***/
...
final class TelnetOutputStream extends OutputStream
{
    ...
    // TODO there does not appear to be any way to change this value - should it
    // be a ctor parameter?
        ...
        synchronized (__client)
        {
            ...
            if (__client._requestedWont(TelnetOption.BINARY)) // i.e. ASCII
            {
                if (__lastWasCR)
                {
                    ...
                    {
                        __client._sendByte('\0'); // RFC854 requires CR NUL for
                                                  // bare CR
                    }
                }
