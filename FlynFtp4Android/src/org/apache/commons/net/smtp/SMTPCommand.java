...
public final class SMTPCommand
{
    ...
    private static final int _NEXT_             = EHLO + 1; // update as
                                                            // necessary when
                                                            // adding new
                                                            // entries
    ...
    private static final String[] _commands = { "HELO", "MAIL FROM:", "RCPT TO:", "DATA", "SEND FROM:", "SOML FROM:", "SAML FROM:", "RSET", "VRFY", "EXPN", "HELP", "NOOP", "TURN", "QUIT", "AUTH",
            "EHLO"                         };
