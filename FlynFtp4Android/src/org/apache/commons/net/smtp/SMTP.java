...
/***
 * SMTP provides the basic the functionality necessary to implement your own
 * SMTP client. To derive the full benefits of the SMTP class requires some
 * knowledge of the FTP protocol defined in RFC 821. However, there is no reason
 * why you should have to use the SMTP class. The
 * {@link org.apache.commons.net.smtp.SMTPClient} class, derived from SMTP,
 * implements all the functionality required of an SMTP client. The SMTP class
 * is made public to provide access to various SMTP constants and to make it
 * easier for adventurous programmers (or those with special needs) to interact
 * with the SMTP protocol and implement their own clients. A set of methods with
 * names corresponding to the SMTP command names are provided to facilitate this
 * interaction.
 * <p>
...
public class SMTP extends SocketClient
{
     ...
     * 
     * @param command
     *            the command to send (as a plain String)
     * @param args
     *            the command arguments, may be {@code null}
     * @param includeSpace
     *            if {@code true}, add a space between the command and its
     *            arguments
     ...
     * 
     * @param command
     *            the command to send (as an int defined in {@link SMPTCommand})
     * @param args
     *            the command arguments, may be {@code null}
     * @param includeSpace
     *            if {@code true}, add a space between the command and its
    ...
    /***
     * Closes the connection to the SMTP server and sets to null some internal
     ...
     * @param args
     *            The arguments to the SMTP command. If this parameter is set to
     ...
     * 
     * @param command
     *            The SMTPCommand constant corresponding to the SMTP command to
     *            send.
     * @param args
     *            The arguments to the SMTP command. If this parameter is set to
     *            null, then the command is sent with no argument.
    ...
    /***
     * Sends an SMTP command with no arguments to the server, waits for a reply
     ...
     * will usually only use this method after you connect to the SMTP server to
     ...
     * are implementing your own SMTP client or if you need to fetch a secondary
    ...
    /***
     * Returns the entire text of the last SMTP server response exactly as it
    ...
    /***
     * A convenience method to send the SMTP HELO command to the server, receive
    ...
    /***
     * A convenience method to send the SMTP MAIL command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @param reversePath
    ...
    /***
     * A convenience method to send the SMTP RCPT command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @param forwardPath
    ...
    /***
     * A convenience method to send the SMTP DATA command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @return The reply code received from the server.
    ...
    /***
     * A convenience method to send the SMTP SEND command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @param reversePath
    ...
    /***
     * A convenience method to send the SMTP SOML command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @param reversePath
    ...
    /***
     * A convenience method to send the SMTP SAML command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @param reversePath
    ...
    /***
     * A convenience method to send the SMTP RSET command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @return The reply code received from the server.
    ...
    /***
     * A convenience method to send the SMTP VRFY command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @param user
    ...
    /***
     * A convenience method to send the SMTP HELP command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @return The reply code received from the server.
    ...
    /***
     * A convenience method to send the SMTP NOOP command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @return The reply code received from the server.
    ...
    /***
     * A convenience method to send the SMTP TURN command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @return The reply code received from the server.
    ...
    /***
     * A convenience method to send the SMTP QUIT command to the server, receive
     * the reply, and return the reply code.
     * <p>
     * 
     * @return The reply code received from the server.
