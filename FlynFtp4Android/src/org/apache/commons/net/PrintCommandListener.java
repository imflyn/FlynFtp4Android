...
public class PrintCommandListener implements ProtocolCommandListener
{
     ...
     * 
     * @param stream
     *            where to write the commands and responses e.g. System.out
     * @since 3.0
     */
     ...
     * @param suppressLogin
     *            if {@code true}, only print command name for login
     * 
     * @since 3.0
     */
     ...
     *            if {@code true}, only print command name for login
     * @param eolMarker
     *            if non-zero, add a marker just before the EOL.
     * 
     * @since 3.0
     */
...
/**
    ...
    public void protocolCommandSent(ProtocolCommandEvent event)
    {
        ...
        if (__nologin)
        {
            ...
            {
                __writer.print(cmd);
                __writer.println(" *******"); // Don't bother with EOL marker
                                              // for this!
            } else
            {
                ...
                { // IMAP
                    ...
                    __writer.print(msg);
                    __writer.println(" *******"); // Don't bother with EOL
                                                  // marker for this!
                } else
                {
