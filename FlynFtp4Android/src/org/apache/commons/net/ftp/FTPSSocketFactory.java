...
public class FTPSSocketFactory extends SocketFactory
{
    ...
    /**
     * @deprecated (2.2) use
     *             {@link FTPSServerSocketFactory#createServerSocket(int)
     *             instead}
     */
    @Deprecated
    ...
    /**
     * @deprecated (2.2) use
     *             {@link FTPSServerSocketFactory#createServerSocket(int, int)
     *             instead}
     */
    @Deprecated
    ...
    /**
     * @deprecated (2.2) use
     *             {@link FTPSServerSocketFactory#createServerSocket(int, int, InetAddress)
     *             instead}
     */
    @Deprecated
    ...
    /**
     * @deprecated (2.2) use
     *             {@link FTPSServerSocketFactory#init(java.net.ServerSocket)}
     */
