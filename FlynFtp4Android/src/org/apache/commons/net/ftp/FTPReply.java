 ...
 * constant names are transcriptions from the code descriptions of RFC 959.
 * <p>
...
public final class FTPReply
{
     ...
     * commands can be issued to the FTP server after a positive preliminary
     ...
     * beginning with a 2 are positive completion responses. The FTP server will
     * send a positive completion response on the final successful completion of
     * a command.
     * <p>
     * 
     * @param reply
     ...
     * beginning with a 3 are positive intermediate responses. The FTP server
     ...
     * successful USER command, a positive intermediate response will be sent to
     ...
     * beginning with a 4 are negative transient responses. The FTP server will
     ...
     * beginning with a 5 are negative permanent responses. The FTP server will
