...
/***
 * The FTPFile class is used to represent information about files stored on an
 * FTP server.
 * <p>
 * <p>
 * 
...
public class FTPFile implements Serializable
{
    ...
    /***
     * Set the number of hard links to this file. This is not to be confused
     * with symbolic links.
     * <p>
     * 
     * @param links
    ...
    /***
     * Return the number of hard links to this file. This is not to be confused
     * with symbolic links.
     * <p>
     * 
    ...
    /***
     * Set the name of the group owning the file. This may be a string
     * representation of the group number.
     * <p>
     * 
     * @param group
    ...
    /***
     * Returns the name of the group owning the file. Sometimes this will be a
    ...
    /***
     * Set the name of the user owning the file. This may be a string
    ...
    /***
     * Returns the name of the user owning the file. Sometimes this will be a
     * string representation of the user number.
     * <p>
     * 
     ...
     * <p>
     * 
     * @return The file pointed to by the symbolic link (null if the FTPFile is
     *         not a symbolic link).
     ***/
    ...
    /***
     * Set the file timestamp. This usually the last modification time. The
     * parameter is not cloned, so do not alter its value after calling this
     * method.
     * <p>
     * 
     * @param date
     ...
     * @param permission
     *            The access permission (one of the <code> _PERMISSION </code>
     *            constants)
     * @param value
     ...
     * currently mimics the Unix listing format.
     * 
     * @return A string representation of the FTPFile information.
     * @since 3.0
     */
