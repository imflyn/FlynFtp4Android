...
public class FTPHTTPClient extends FTPClient
{
    ...
    private String              tunnelHost;             // Save the host when
                                                         // setting up a tunnel
                                                         // (needed for EPSV)
    ...
    // Not strictly necessary, but Clirr complains even though there is a
    // super-impl
    @Override
    @Deprecated
    ...
    private void tunnelHandshake(String host, int port, InputStream input, OutputStream output) throws IOException, UnsupportedEncodingException
    {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(input, getCharsetName())); // Java
                                                                                                    // 1.6
                                                                                                    // can
                                                                                                    // use
                                                                                                    // getCharset()
