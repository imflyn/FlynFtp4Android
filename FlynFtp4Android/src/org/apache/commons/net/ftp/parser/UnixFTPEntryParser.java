...
public class UnixFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
    ...
    static final String                 DEFAULT_DATE_FORMAT        = "MMM d yyyy";                                                                               // Nov
                                                                                                                                                                  // 9
                                                                                                                                                                  // 2001

    static final String                 DEFAULT_RECENT_DATE_FORMAT = "MMM d HH:mm";                                                                              // Nov
                                                                                                                                                                  // 9
                                                                                                                                                                  // 20:06
     ...
     * <code>"yyyy-MM-dd HH:mm</code>. This is a very welcome development, and
     * hopefully it will soon become the standard. However, since it is so new,
     * for now, and possibly forever, we merely accomodate it, but do not make
     * it the default.
     * <p>
     ...
     * state) e z/OS external link bit
     */
    private static final String         REGEX                      = "([bcdelfmpSs-])" + "(((r|-)(w|-)([xsStTL-]))((r|-)(w|-)([xsStTL-]))((r|-)(w|-)([xsStTL-])))\\+?\\s*" + "(\\d+)\\s+" // link
                                                                                                                                                                                          // count
                                                                           + "(?:(\\S+(?:\\s\\S+)*?)\\s+)?" // owner
                                                                                                            // name
                                                                                                            // (optional
    ...
    public FTPFile parseFTPEntry(String entry)
    {
        ...
        if (matches(entry))
        {
            ...
            // A 'whiteout' file is an ARTIFICIAL entry in any of several types
            // of
            ...
            switch (typeStr.charAt(0))
            {
                ...
                case 'c':
                    isDevice = true;
                    type = FTPFile.FILE_TYPE; // TODO change this if DEVICE_TYPE
                                              // implemented
                    break;
                case 'f':
                case '-':
