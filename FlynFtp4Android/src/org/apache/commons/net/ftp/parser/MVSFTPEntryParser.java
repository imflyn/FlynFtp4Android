...
public class MVSFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
     ...
     * filetype=<SEQ|JES|DB2> SEQ is the default and used for normal file
     * transfer JES is used to interact with the Job Entry Subsystem (JES)
     * similar to a job scheduler DB2 is used to interact with a DB2 subsystem
     * 
    ...
    public List<String> preParse(List<String> orig)
    {
        ...
        if (orig != null && orig.size() > 0)
        {
            ...
            {// header contains JOBNAME JOBID OWNER // STATUS CLASS
