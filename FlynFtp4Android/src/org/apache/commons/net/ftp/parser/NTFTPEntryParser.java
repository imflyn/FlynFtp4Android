 ...
 * @version $Id: NTFTPEntryParser.java 1489361 2013-06-04 09:48:36Z sebb $
...
public class NTFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
    ...
    private static final String      DEFAULT_DATE_FORMAT  = "MM-dd-yy hh:mma"; // 11-09-01
                                                                               // 12:30PM

    private static final String      DEFAULT_DATE_FORMAT2 = "MM-dd-yy kk:mm"; // 11-09-01
                                                                               // 18:30
     ...
     */
    private static final String      REGEX                = "(\\S+)\\s+(\\S+)\\s+" // MM-dd-yy
                                                                                   // whitespace
                                                                                   // hh:mma|kk:mm;
                                                                                   // swallow
                                                                                   // trailing
    ...
    /**
     * This constructor allows the creation of an NTFTPEntryParser object with
