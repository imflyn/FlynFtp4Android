...
public abstract class ConfigurableFTPFileEntryParserImpl extends RegexFTPFileEntryParserImpl implements Configurable
{
     ...
     * 
     * @param regex
     *            Regular expression used main parsing of the file listing.
     */
    ...
    /**
     * This method is called by the concrete parsers to delegate timestamp
     * parsing to the timestamp parser.
     * <p>
     * 
     * @param timestampStr
     *            the timestamp string pulled from the file listing by the
     *            regular expression parser, to be submitted to the
     ...
     * Configures this parser by delegating to the underlying Configurable
     * FTPTimestampParser implementation, ' passing it the supplied
     * {@link FTPClientConfig FTPClientConfig} if that is non-null or a default
     * configuration defined by each concrete subclass.
     * 
     * @param config
     *            the configuration to be used to configure this parser. If it
     *            is null, a default configuration defined by each concrete
     *            subclass is used instead.
     */
    // @Override
    @Override
