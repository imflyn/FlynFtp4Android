...

{
    ...
    private static final String DEFAULT_DATE_FORMAT = "MM-dd-yy HH:mm"; // 11-09-01
                                                                         // 12:30
    /**
     * this is the regular expression used by this parser.
     */
    private static final String REGEX               = "\\s*([0-9]+)\\s*" + "(\\s+|[A-Z]+)\\s*" + "(DIR|\\s+)\\s*" + "(\\S+)\\s+(\\S+)\\s+" /*
                                                                                                                                            * date
                                                                                                                                            * stuff
                                                                                                                                            */
                                                            + "(\\S.*)";
    ...
    /**
     * This constructor allows the creation of an OS2FTPEntryParser object with
