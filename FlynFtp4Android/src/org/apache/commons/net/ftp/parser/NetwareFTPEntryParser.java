 ...
 * Systems. Note that some of the proprietary extensions for Novell-specific
 * operations are not supported. See <a href=
 * "http://www.novell.com/documentation/nw65/index.html?page=/documentation/nw65/ftp_enu/data/fbhbgcfa.html"
 * >http://www.novell.com/documentation/nw65/index.html?page=/documentation/nw65
 * /ftp_enu/data/fbhbgcfa.html</a> for more details.
 * 
 * @author <a href="rwinston@apache.org">Rory Winston</a>
 * @see org.apache.commons.net.ftp.FTPFileEntryParser FTPFileEntryParser (for
 *      usage instructions)
 * @version $Id: NetwareFTPEntryParser.java 1489361 2013-06-04 09:48:36Z sebb $
 * @since 1.5
 */
public class NetwareFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
    ...
    /**
     * this is the regular expression used by this parser. Example: d [-W---F--]
     * SCION_VOL2 512 Apr 13 23:12 VOL2
     */
     ...
     * <li><b>C</b> - Create; Right to create; when assigned to a file, allows a
     ...
     * 
     * See <a href=
     * "http://www.novell.com/documentation/nfap10/index.html?page=/documentation/nfap10/nfaubook/data/abxraws.html"
