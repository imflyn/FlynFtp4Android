...
public class POP3Client extends POP3
{
     ...
     * the {@link org.apache.commons.net.pop3.POP3#AUTHORIZATION_STATE
    ...
    public boolean login(String username, String timestamp, String secret) throws IOException, NoSuchAlgorithmException
    {
        ...
        for (i = 0; i < digest.length; i++)
        {
            ...
            if (digit <= 15)
            { // Add leading zero if necessary (NET-351)
     ...
     * call {@link org.apache.commons.net.pop3.POP3#disconnect disconnect }. A
     * logout attempt is valid in any state. If the client is in the
     * {@link org.apache.commons.net.pop3.POP3#TRANSACTION_STATE
     * TRANSACTION_STATE } , it enters the
     * {@link org.apache.commons.net.pop3.POP3#UPDATE_STATE UPDATE_STATE } on a
     * successful logout.
     * <p>
     * 
    ...
    public POP3MessageInfo[] listMessages() throws IOException
    {
        ...
        POP3MessageInfo[] messages = new POP3MessageInfo[_replyLines.size() - 2]; // skip
                                                                                  // first
                                                                                  // and
                                                                                  // last
                                                                                  // lines

        ListIterator<String> en = _replyLines.listIterator(1); // Skip first
                                                               // line
     ...
     * BufferedReader instance. The POP3 protocol uses the same stream for
     * issuing commands as it does for returning results. Therefore the returned
     * BufferedReader actually reads directly from the POP3 connection. After
     ...
     *         message can be read. This can safely be cast to a
     *         {@link java.io.BufferedReader BufferedReader} in order to use the
     *         {@link java.io.BufferedReader#readLine()
     *         BufferedReader#readLine()} method. Returns null if the retrieval
     *         attempt fails (e.g., if the specified message number does not
     *         exist).
     * @exception IOException
     *                If a network I/O error occurs in the process of sending
     ...
     *         top number of lines of the message can be read. This can safely
     *         be cast to a {@link java.io.BufferedReader BufferedReader} in
     *         order to use the {@link java.io.BufferedReader#readLine()
     *         BufferedReader#readLine()} method. Returns null if the retrieval
     *         attempt fails (e.g., if the specified message number does not
     *         exist).
     * @exception IOException
