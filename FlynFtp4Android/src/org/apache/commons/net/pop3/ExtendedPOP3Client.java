...
{
    /**
     * The default ExtendedPOP3Client constructor. Creates a new Extended POP3
     * Client.
     * 
    ...
    public boolean auth(AUTH_METHOD method, String username, String password) throws IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException
    {
        ...
        switch (method)
        {
            case PLAIN:
                ...
                // to read it.
                return sendCommand(new String(Base64.encodeBase64(("\000" + username + "\000" + password).getBytes(getCharsetName())), getCharsetName()) // Java
                                                                                                                                                         // 1.6
                                                                                                                                                         // can
                                                                                                                                                         // use
                                                                                                                                                         // getCharset()
