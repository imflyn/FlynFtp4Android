 ...
 * POP3. If implicit mode is selected (NOT the default), SSL/TLS negotiation
 ...
 * server accepts the command. Implicit usage: POP3SClient c = new
 * POP3SClient(true); c.connect("127.0.0.1", 995); Explicit usage: POP3SClient c
 * = new POP3SClient(); c.connect("127.0.0.1", 110); if (c.execTLS()) { /rest of
 * the commands here/ }
 * 
 * @since 3.0
 */
public class POP3SClient extends POP3Client
{
    ...
    /**
     * Constructor for POP3SClient. Sets the default port to
     * {@link #DEFAULT_POP3S_PORT} - 995 - if using implicit mode
     * 
     * @param proto
     *            the protocol.
     * @param implicit
    ...
    /**
     * Constructor for POP3SClient, using {@link #DEFAULT_PROTOCOL} - TLS - and
     * isImplicit = false
     * 
     * @param context
     *            A pre-configured SSL Context.
