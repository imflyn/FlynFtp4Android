...
public final class TFTPDataPacket extends TFTPPacket
{
    ...
    /***
     * Creates a data packet to be sent to a host at a given port with a given
     * block number. The actual data to be sent is passed as an array, an
     * offset, and a length. The offset is the offset into the byte array where
     * the data starts. The length is the length of the data. If the length is
     * greater than MAX_DATA_LENGTH, it is truncated.
     * <p>
     * 
     * @param destination
     ...
     * @param offset
     *            The offset into the array where the data starts.
     * @param length
     *            The length of the data.
     ***/
    ...
    /***
     * Creates a data packet based from a received datagram. Assumes the
     ...
     *             If the datagram isn't a valid TFTP data packet.
     ***/
    ...
    /***
     * Creates a UDP datagram containing all the TFTP data packet data in the
