...
public final class TFTPErrorPacket extends TFTPPacket
{
    ...
    /***
     * Creates an error packet to be sent to a host at a given port with an
    ...
    /***
     * Creates an error packet based from a received datagram. Assumes the
     * datagram is at least length 4, else an ArrayIndexOutOfBoundsException may
     * be thrown.
     * <p>
     * 
     * @param datagram
     *            The datagram containing the received error.
     * @throws TFTPPacketException
     *             If the datagram isn't a valid TFTP error packet.
     ***/
    ...
    /***
     * Creates a UDP datagram containing all the TFTP error packet data in the
