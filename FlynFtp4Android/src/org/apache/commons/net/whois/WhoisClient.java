 ...
 * Protocol defined in RFC 954. To query a host you create a WhoisClient
 * instance, connect to the host, query the host, and finally disconnect from
 * the host. If the whois service you want to query is on a non-standard port,
...
public final class WhoisClient extends FingerClient
{
    ...
    /***
     * Queries the connected whois server for information regarding the given
     * handle. It is up to the programmer to be familiar with the handle syntax
     * of the whois server. You must first connect to a whois server before
    ...
    /***
     * Queries the connected whois server for information regarding the given
     * handle and returns the InputStream of the network connection. It is up to
     * the programmer to be familiar with the handle syntax of the whois server.
     * You must first connect to a finger server before calling this method, and
     * you should disconnect after finishing reading the stream.
     * <p>
     * 
     * @param handle
     *            The handle to lookup.
     * @return The InputStream of the network connection of the whois query. Can
     *         be read to obtain whois results.
     * @exception IOException
     *                If an I/O error occurs during the operation.
     ***/
