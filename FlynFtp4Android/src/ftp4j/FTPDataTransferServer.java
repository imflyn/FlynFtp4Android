...
class FTPDataTransferServer implements FTPDataTransferConnectionProvider, Runnable
{
    ...
    public FTPDataTransferServer() throws FTPDataTransferException
    {
        ...
        if (aux != null)
        {
            ...
            if (!valid)
            {
                ...
                System.err.println("WARNING: invalid value \"" + aux + "\" for the " + FTPKeys.ACTIVE_DT_PORT_RANGE + " system property. The value should " + "be in the start-stop form, with "
    ...
    public void run()
    {
        ...
        if (aux != null)
        {
            ...
            {
                // warning to the developer
                System.err.println("WARNING: invalid value \"" + aux + "\" for the " + FTPKeys.ACTIVE_DT_ACCEPT_TIMEOUT + " system property. The value should "
    ...
    public Socket openDataTransferConnection() throws FTPDataTransferException
    {
        ...
        if (exception != null)
        {
            throw new FTPDataTransferException("Cannot receive the incoming connection", exception);
        }
        if (socket == null)
        {
